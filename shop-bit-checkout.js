...
try{
 ...
 document.getElementById('summaryTotal').innerHTML=`<small>משלוח חינם</small><span>סה״כ לתשלום</span><strong>${money(total)}</strong>`;
